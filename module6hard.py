...
class Triangle(Figure):
    ...
    def __init__(self, color, sides):
        ...
        self.__height = 0
        self.__square = 0
        self.__semi_perimeter = sum(sides) / 2
    ...
    def get_square(self):
        self.__square = (self.__semi_perimeter * (self.__semi_perimeter - self.__a)
                         * (self.__semi_perimeter - self.__b)
                         * (self.__semi_perimeter - self.__c)) ** 0.5
